<footer class="bg-green-900" aria-labelledby="footer-heading">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
            ...
            <div
                ...
                <div class="flex space-x-6 md:order-2">
                    ...
                    <a href="https://www.youtube.com/channel/UC6X3pd9RW4ajslFtx87DnLg" class="text-white hover:text-gray-400" target="_blank">
