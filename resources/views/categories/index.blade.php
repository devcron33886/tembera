        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8 py-24">
            <div class="lg:flex lg:items-center lg:justify-between">
                <div class="min-w-0 flex-1">
                    <h1 class="text-2xl font-bold leading-7 text-white sm:truncate sm:text-3xl sm:tracking-tight">Blog / {{ $category->name}}</h1>
            ...
            <div class="mx-auto mt-4 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                ...
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <a href="{{ route('blog-detail',$post->slug) }}">
                        <img class="rounded-t-lg h-auto" src="{{ $post->featured_image->getUrl('preview') }}" alt="{{ $post->title}}" />
                    </a>
                    @endif
                    <div class="p-5">
                        <a href="{{ route('blog-detail',$post->slug) }}">
