    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text" name="mobile" id="mobile" value="{{ old('mobile', $setting->mobile) }}" required>
            ...
            <div class="form-group">
                <label for="google">{{ trans('cruds.setting.fields.google') }}</label>
                <input class="form-control {{ $errors->has('google') ? 'is-invalid' : '' }}" type="text" name="google" id="google" value="{{ old('google', $setting->google) }}">
                @if($errors->has('google'))
                    <span class="text-danger">{{ $errors->first('google') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.setting.fields.google_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="featured_image">{{ trans('cruds.setting.fields.featured_image') }}</label>
                <div class="needsclick dropzone {{ $errors->has('featured_image') ? 'is-invalid' : '' }}" id="featured_image-dropzone">
                </div>
                @if($errors->has('featured_image'))
                    <span class="text-danger">{{ $errors->first('featured_image') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.setting.fields.featured_image_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    init: function () {
@if(isset($setting) && $setting->featured_image)
      var file = {!! json_encode($setting->featured_image) !!}
