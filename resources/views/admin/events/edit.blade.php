...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.update", [$event->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="starting_date">{{ trans('cruds.event.fields.starting_date') }}</label>
                <input class="form-control date {{ $errors->has('starting_date') ? 'is-invalid' : '' }}" type="text" name="starting_date" id="starting_date" value="{{ old('starting_date', $event->starting_date) }}" required>
                @if($errors->has('starting_date'))
                    <span class="text-danger">{{ $errors->first('starting_date') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.event.fields.starting_date_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="ending_date">{{ trans('cruds.event.fields.ending_date') }}</label>
                <input class="form-control date {{ $errors->has('ending_date') ? 'is-invalid' : '' }}" type="text" name="ending_date" id="ending_date" value="{{ old('ending_date', $event->ending_date) }}">
                @if($errors->has('ending_date'))
                    <span class="text-danger">{{ $errors->first('ending_date') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.event.fields.ending_date_helper') }}</span>
            </div>
            <div class="form-group">
