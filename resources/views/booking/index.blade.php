                    ...
                    <form method="POST" action="/book-now">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="check-in-date" class="block mt-1 w-full" type="datetime-local"
                                    name="check_in_date" :value="old('check_in_date')" autocomplete="date" />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="check-out-date" class="block mt-1 w-full" type="datetime-local"
                                    name="check_out_date" :value="old('check_out_date')" autocomplete="date" />
                            ...
                            <div class="mt-4">
                                ...
                                <textarea name="message" id="message" rows="5" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('message') }}</textarea>
